...
class VerificationAgent:
    ...
    def _create_session_dir(self, platform: str):
        ...
        self.session_dir = self.output_dir / f"{platform}_verification_{timestamp}"
    ...
    def _capture_product_screenshot(self, index: int) -> Optional[str]:
        ...
        try:
            ...
            screenshot_path = self.session_dir / "screenshots" / f"product_{index}.png"
...
def interactive_mode():
    ...
    while True:
        ...
        max_str = input("最大商品数 (默认5): ").strip()
        max_products = int(max_str) if max_str.isdigit() else 5
